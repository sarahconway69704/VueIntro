...
var vm = new Vue({
  ...
  created: function() {
      // run a fetch call and get user data 
  ...
  methods: {
    ...
    getUserData(){
      // do a fetch call here and get user from the database
    ...
    userLogin() {
      ...
      // the expression evuates to true or false - if it's true, set the value equal to 
